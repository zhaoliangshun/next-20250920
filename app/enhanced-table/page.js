...
import EnhancedFixedColumnTable from '../../components/EnhancedFixedColumnTable';
...
export default function EnhancedTableExample() {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>增强版固定列表格</h1>
      <p className={styles.description}>
        左右滑动表格，观察左侧固定列的变化。当滑动到右侧时，左侧固定列会平滑缩小为图标，并带有过渡动画效果。
      </p>
      ...
      <div className={styles.tableWrapper}>
        <EnhancedFixedColumnTable 
          data={data}
          columns={columns}
          fixedColumnKey="name"
          fixedColumnWidth={220}
          collapsedWidth={60}
          collapseThreshold={100} // 设置折叠触发的滚动阈值
