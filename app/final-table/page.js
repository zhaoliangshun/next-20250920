...
import FixedColumnTableFinal from '../../components/FixedColumnTableFinal';
import styles from './page.module.css';

export default function FinalTableExample() {
  // 示例数据
  const data = [
    { 
      id: 1, 
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.title}>固定列表格 - 最终版</h1>
      <p className={styles.description}>
        此表格将固定列和其他内容放在同一个表格DOM结构中，确保行内容完美对齐。
        左右滑动表格，观察左侧固定列的变化。
      </p>
